 ...
 * 你希望在队伍中向前移动，但队伍中每个人都会收取一定的费用才能与你交换位置。与编号 i 的人交换位置的费用为 cost[i] 。
 * 你可以按照以下规则与他人交换位置：
 * 如果对方在你前面，你必须支付cost[i]费用与他们交换位置。
 * 如果对方在你后面，他们可以免费与你交换位置。
 * 返回一个大小为 n 的数组 answer，其中 answer[i] 表示到达队伍中每个位置 i 所需的最小总费用。
 *
 * 示例 1：
 * 输入: cost = [5,3,4,1,3,2]
 * 输出: [5,3,3,1,1,1]
